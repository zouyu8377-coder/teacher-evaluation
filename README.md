...
[![Version](https://img.shields.io/badge/version-1.4.3-blue.svg)](https://github.com/zouyu8377-coder/teacher-evaluation)
...
| 版本 | 日期 | 主要变更 |
|------|------|---------|
| v1.4.3 | 2026-07-07 | 增加用户 Excel 模板下载、批量导入更新、筛选导出；优化教师活动可见性与发布成绩截止逻辑 |
